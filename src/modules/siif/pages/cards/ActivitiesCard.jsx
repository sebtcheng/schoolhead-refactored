    ...
    const renderFormScreen = () => (
        <div className="flex-1 overflow-y-auto px-5 py-6 space-y-3 pb-36">
            ...
            {selectedInterventions.map(intId => {
                ...
                return (
                    <div key={intId} className="bg-white rounded-[2rem] border border-slate-100 shadow-sm p-4 sm:p-5 flex flex-col gap-3 hover:border-siif-blue/30 transition-all duration-300">
                ...
                <div className="relative z-10 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h1 className="text-xl font-black italic uppercase tracking-tight">Planned Activities</h1>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
