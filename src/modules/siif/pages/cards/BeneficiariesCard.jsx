            ...
            {selectedInterventions.map(intId => {
                ...
                return (
                    <div
                        ...
                        className={`bg-white rounded-[2rem] border border-slate-100 shadow-sm p-4 sm:p-5 flex flex-col gap-3 transition-all duration-300 ${
                            !readOnly ? 'cursor-pointer hover:border-siif-blue/30 hover:shadow-md' : ''
                        }`}
                    >
