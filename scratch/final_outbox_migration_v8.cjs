...
async function migrate() {
  ...
  try {
    console.log("--- STARTING MIGRATION V8: EXPLICIT DATE OBJECTS ---");
    ...
    for (const project of orphans) {
      const isActuallyActive = (project.engineer_id); // Simple check for now
