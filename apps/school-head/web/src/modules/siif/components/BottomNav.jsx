        ...
        <aside className="siif-sidebar z-[1000] print:hidden">
            ...
            <div className="siif-sidebar-footer mt-auto pt-4 border-t border-white/10 flex flex-col gap-2 transition-all duration-300 w-full">
                ...
                <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sky-200 hover:text-white hover:bg-white/10 text-xs font-bold transition-all overflow-hidden border-0 bg-transparent cursor-pointer"
                    title="Go Back to Nexus"
                >
                    <FiArrowLeft size={16} className="shrink-0" />
                    <span className="siif-text-label">Go Back to Nexus</span>
                </button>
                <button
