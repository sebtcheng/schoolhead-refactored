...
import { TbUser, TbBell, TbLock, TbLogout, TbHelp } from 'react-icons/tb';
        ...
        <div className="min-h-screen bg-slate-50 pb-32">
            ...
            <div className="px-6 -mt-10 relative z-20 space-y-4">
                ...
                <button 
                    ...
                    className="w-full p-5 bg-red-50 text-red-600 rounded-3xl font-bold flex items-center justify-center gap-2 border border-red-100"
                >
                    <TbLogout size={18} /> Sign Out of SIIF
                </button>
            </div>
        </div>
    );
